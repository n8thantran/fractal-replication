"""
Run remaining synthetic experiments (RSG and Repliclust) with ultra-fast OPTICS.
"""
import numpy as np
import json
import os
...
def main():
    ...
    for dtype, gen_fn, cfgs in [
        ...
        ('Repliclust', gen_repliclust, [(k, d) for k in [2, 5] for d in [10, 50, 200]]),
    ]:
        print(f"\n{'='*60}")
